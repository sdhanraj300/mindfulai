...
export function TerminalLoader({
  ...
  return (
    ...
    >
      <span className={cn("text-black! font-mono", textSizes[size])}>
        {">"}
      </span>
      <div
        className={cn(
...
export function TextDotsLoader({
  ...
  return (
    ...
    >
      <span className={cn("text-black! font-medium", textSizes[size])}>
        {text}
      </span>
      <span className="inline-flex">
        <span className="text-black! animate-[loading-dots_1.4s_infinite_0.2s]">
          .
        </span>
        <span className="text-black! animate-[loading-dots_1.4s_infinite_0.4s]">
          .
        </span>
        <span className="text-black! animate-[loading-dots_1.4s_infinite_0.6s]">
          .
        </span>
      </span>
    </div>
